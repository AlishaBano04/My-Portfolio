...
//       {/* Mobile Menu */}
//       <div
//         className={`fixed inset-0 h-screen w-full bg-[#fefae0] dark:bg-black flex flex-col justify-center items-center space-y-8 text-xl font-medium transition-transform duration-300 ease-in-out z-40 ${
